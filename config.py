...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7069720824:AAFNAj4GfJUtsTBgqW7yJQ18MVD4v3NEX_4")
...
DB_NAME = os.environ.get("DATABASE_NAME", "Legend bot")
...
FORCE_SUB_CHANNEL_3 = int(os.environ.get("FORCE_SUB_CHANNEL_3", "-1002043812128"))
